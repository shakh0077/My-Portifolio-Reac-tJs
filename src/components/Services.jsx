...
function Services() {
  ...
  return (
    <div className="bg-black/90 mt-30 overflow-hidden">
      <div className="container " id="services">
        <div className="relative top-0 left-0">
          <img src={BgImg} alt="rasmlar" />
          <div className="flex gap-64 left-20 absolute top-5 text-white  justify-between">
            <h1 data-aos="fade-right" className="text-4xl font-bold">
              My <br className="block lg:hidden" />{" "}
            ...
            <h3 data-aos="fade-left" className="hidden max-w-[700px] lg:block">
              ...
              bo‘lsangiz, onlayn mavjudligingizni optimallashtirmoqchi
              bo‘lsangiz yoki noyob raqamli tajriba qurmoqchi bo‘lsangiz,
              zamonaviy veb-texnologiyalar yordamida orzuingizni amalga
              oshirishda yordam bera olaman. Keling, birgalikda ajoyib bir narsa
              yaratamiz!
            </h3>
          </div>
          <div
            data-aos="fade-down"
            className="absolute top-40 right-10 lg:left-60"
          >
            <img
              src={ServicesImg}
              className="w-[200px] lg:w-[800px] "
              alt="serviseImg"
            />
          </div>
          ...
          <div className="absolute bottom-0 lg:bottom-20 text-white left-1/3 lg:left-2/5 flex  gap-5 text-1xl lg:text-3xl ">
            <a
              data-aos="fade-right"
              className="hover:text-amber-500 hover:scale-125 transition-transform duration-500 ease-in-out"
              href="shalh_077_01"
            >
              <FaTelegram />
            </a>
